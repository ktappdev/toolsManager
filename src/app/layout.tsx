    ...
    <ClerkProvider>
      <QueryProvider>
        <html lang="en">
          ...
          >
            <div className="max-w-3xl mx-auto h-full flex flex-1 flex-col gap-2">
              ...
              <div className="flex flex-col justify-center items-center w-full h-[calc(100vh-100px)] mt-24 overflow-scroll">
                {/* h-[calc(100vh-100px)] */}
                {children}
              </div>
